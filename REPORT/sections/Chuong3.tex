...
Nhóm xây dụng module Loader cho phép nhận các dữ liệu đầu vào có đuôi xlsx, xls, csx và json.

\begin{itemize}
    \item \textbf{Đầu vào:} Đường dẫn file dữ liệu.
    \item \textbf{Đầu ra:} \textit{DataFrame} chứa dữ liệu đã được đọc từ file.
\end{itemize}
...
\label{tab:processed_examples}   % <--- LABEL Ở ĐÂY
\renewcommand{\arraystretch}{1.3}

\begin{tabularx}{\textwidth}{c c c X c c X}
\hline
\textbf{No} & \textbf{unnamed} & \textbf{Emotion} & \textbf{Sentence} 
& \textbf{merged\_label} & \textbf{label\_id} & \textbf{processed} \\
\hline

0 & 0 & Disgust & hỏi nhạy khiếp & Tiêu cực & 1 & {["nhạy", "khiếp"]} \\

2 & 1944 & Surprise & con người giỏi nhỉ . & Tích cực & 0 & {["con\_người", "giỏi"]} \\

3 & 1711 & Other & má 2 thằng áo vàng lầy ghê & Trung tính & 2 & 
{["má", "2", "thằng", "áo", "vàng", "lầy", "ghê", "trung\_tính"]} \\
