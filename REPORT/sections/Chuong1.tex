...
\begin{figure}[ht]
    ...
    \caption{Hình 1. Support Vector Machine}
    \label{fig:1.2.2}
\end{figure}
...
Trong khuôn khổ báo cáo này, nhóm không trình bày chi tiết các biểu thức toán học của từng loại kernel, bạn có thể tham khảo công thức đầy đủ ở tài liệu sau: \cite{cortes1995support}
